<script setup lang="ts">
	...
	function onChange() {}
	// value 映射 label
	function formatData(val: any, schema: any) {
		let selectOptions = proxy.$uv.deepClone(schema?.componentProps?.options) || [];
		let obj = selectOptions.find((m: any) => {
